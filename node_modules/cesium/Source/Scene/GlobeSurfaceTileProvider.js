define([
    ...
    GlobeSurfaceTileProvider.prototype._onLayerAdded = function(layer, index) {
        if (layer.show) {
            ...
            imageryProvider._reloadVectorTile = function(canvas) {
                that._quadtree.forEachLoadedTile(function(tile) {
                    if(tile.x === canvas.xMvt && tile.y === canvas.yMvt && tile.level === canvas.zMvt){
                        ...
                        for (i = 0; i < length; ++i) {
                            ...
                            // layer._imageryCache['['+ canvas.xMvt+','+canvas.yMvt+','+canvas.zMvt+']'] = imagery;
                            if (imagery.imageryLayer === layer) {
                                // layer._imageryCache['['+ canvas.xMvt+','+canvas.yMvt+','+canvas.zMvt+']'] = imagery;
                                if (startIndex === -1) {
                                    startIndex = i;
